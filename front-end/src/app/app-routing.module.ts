...
const routes: Routes = [
  ...
  { path: 'show-question/:id/:questionId', component: ShowQuestionComponent},
  ...
  {path: 'question-explication/:id/:questionId/:reponseId', component: QuestionExplicationComponent},
